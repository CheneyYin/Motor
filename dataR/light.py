...
train_N_path = 'D:\\电音检测\\dataR\\Features\\train_N.csv'
train_P_path = 'D:\\电音检测\\dataR\\Features\\train_P.csv'
test_path = 'D:\\电音检测\\dataR\\Features\\test.csv'
sub_path = 'D:\\电音检测\\dataR\\Features\\sub\\sub1.csv'
...
print p_list_midl[int(len(p_list_midl)*0.5)] 
